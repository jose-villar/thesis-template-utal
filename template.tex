...
\newenvironment{acknowledgement}{
  ...
  \centerline{\bf\MakeUppercase{Agradecimientos}}
  \onehalfspacing
  \vspace{2.5em}
  }
{
...
\newenvironment{myabstract}{
  ...
  \centerline{\bf\MakeUppercase{Resumen}}
  \onehalfspacing
  \vspace{2.5em}
  }{
  \newpage
...
\begin{figure}[h]
  \centering \resizebox{2.3cm}{2.8cm}{\includegraphics{utalca.png}}
\end{figure}
...
\begin{center}
\singlespacing
  \large \MakeUppercase{\textbf{Universidad de Talca}}\hfill \\
  \large \MakeUppercase{Facultad de Ingeniería}\hfill \\
  \large \MakeUppercase{ESCUELA DE INGENIERÍA CIVIL EN COMPUTACIÓN}\hfill
\end{center}
}
